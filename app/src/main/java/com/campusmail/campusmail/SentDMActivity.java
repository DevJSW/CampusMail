...
public class SentDMActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_dm);
        ...
        mDatabase.keepSynced(true);
        mQueryLetters = mDatabase.orderByChild("sender_uid").equalTo(mAuth.getCurrentUser().getUid());
        ...
        mDatabaseUsers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.hasChild(user_id)) {
                    ...
                    Intent intent = new Intent(SentDMActivity.this, EditActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Letters, LetterViewHolder> firebaseRecyclerAdapter = new  FirebaseRecyclerAdapter<Letters, LetterViewHolder>(
                ...
                Letters.class,
                R.layout.letter_mail_row_delete,
            ...
            protected void populateViewHolder(final LetterViewHolder viewHolder, final Letters model, int position) {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mDatabaseUsers.child(sender_uid).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Picasso.with(SentDMActivity.this).load(post_image).into(viewHolder.mImage);
                ...
                viewHolder.mImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent cardonClick = new Intent(SentDMActivity.this, ViewProfileActivity.class);
                ...
                viewHolder.mDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    private AlertDialog AskOption() {
                        ...
                        AlertDialog myQuittingDialogBox =new AlertDialog.Builder(SentDMActivity.this)
                ...
                viewHolder.mChatBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent cardonClick = new Intent(SentDMActivity.this, DmChatActivity.class);
                        cardonClick.putExtra("heartraise_id", post_key );
                        startActivity(cardonClick);
                    }
                });
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        viewHolder.mCall.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ActivityCompat.checkSelfPermission(SentDMActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public static class LetterViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView mChatBtn, mCall,mCardPhoto, mInside, mImage, mShareBtn, mDelete;
        TextView mName;
