...
public class CMSearchResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmsearch_result);
        ...
        mDatabaseUsers.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.hasChild(user_id)) {
                    ...
                    Intent intent = new Intent(CMSearchResult.this, EditActivity.class);
            ...
            protected void populateViewHolder(final LetterViewHolder viewHolder, final Letters model, int position) {
                ...
                viewHolder.mChatBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent cardonClick = new Intent(CMSearchResult.this, DmChatActivity.class);
                    ...
                    if (!TextUtils.isEmpty(quiz_value) && !TextUtils.isEmpty(ex_value)) {
                        ...
                        mDatabaseUsers.child(user_id).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(CMSearchResult.this);
