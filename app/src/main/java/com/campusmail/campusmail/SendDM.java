...
public class SendDM extends AppCompatActivity {
    ...
    private DatabaseReference mDatabaseLetters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_dm);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mPostKey = getIntent().getExtras().getString("reciever_id");

        mDatabaseUser = FirebaseDatabase.getInstance().getReference().child("Users");
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Directmails");
        mDatabaseLetters = FirebaseDatabase.getInstance().getReference().child("Letters");
            ...
            if ( mImageUri != null) {
                ...
                filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        mDatabaseLetters.child(mPostKey).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(SendDM.this);
