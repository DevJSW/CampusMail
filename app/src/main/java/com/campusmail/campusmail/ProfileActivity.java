...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQueryPostComment = mDatabase.orderByChild("uid").equalTo(mAuth.getCurrentUser().getUid());
        ...
        mDatabaseUsers.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfileActivity.this).load(post_image).into(mPostImage);
            }
    ...
    private void checkForNetwork() {
        ...
        if (ninfo != null && ninfo.isConnected()) {
            ...
            Toast.makeText(ProfileActivity.this, "You are not connected to Internet... Please Enable Internet!", Toast.LENGTH_LONG)
                    .show();
            ...
            protected void populateViewHolder(final LetterViewHolder viewHolder, final Letter model, int position) {
                ...
                viewHolder.mPostImg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent cardonClick = new Intent(ProfileActivity.this, ViewLetterProfileActivity.class);
                ...
                viewHolder.mDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    private AlertDialog AskOption() {
                        ...
                        AlertDialog myQuittingDialogBox =new AlertDialog.Builder(ProfileActivity.this)
